       ...
       <div className="flex-1 flex flex-col overflow-hidden bg-stone-50/50 relative">
           ...
           <div className="h-20 border-b border-stone-200 flex items-center justify-between px-8 bg-white shrink-0 shadow-sm">
               ...
               <div className="flex gap-2 items-center">
                   ...
                   {['TXT', 'SRT'].map(fmt => (
                        <button key={fmt} onClick={() => handleDownload(fmt as any)} className="flex items-center gap-2 px-4 py-2 bg-white border border-stone-200 text-stone-600 rounded-lg text-xs font-bold hover:bg-stone-50 transition-colors shadow-sm">
